...
public class TestNameNodeMXBean {
  ...
  public void testNameNodeMXBeanInfo() throws Exception {
    ...
    try {
      cluster = new MiniDFSCluster(conf, 2, true, null, true);
      cluster.waitActive();
      ...
      // get attribute NamespaceId
      int namespaceId = (Integer) (mbs.getAttribute(mxbeanName,
          "NamespaceId"));
      Assert.assertEquals(fsn.getNamespaceInfo().getNamespaceID(), namespaceId);
    } finally {
      if (cluster != null) {
        cluster.shutdown();
      }
