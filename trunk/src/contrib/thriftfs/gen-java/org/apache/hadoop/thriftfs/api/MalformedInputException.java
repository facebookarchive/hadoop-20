...
public class MalformedInputException extends Exception implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("MalformedInputException");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MalformedInputException.class, metaDataMap);
  }
  ...
  @Override
  public MalformedInputException clone() {
