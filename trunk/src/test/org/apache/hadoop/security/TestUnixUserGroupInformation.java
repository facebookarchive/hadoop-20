...
public class TestUnixUserGroupInformation extends TestCase {
  ...
  public void testGetUnixUsername() throws IOException {
    String usernameViaWhoami = Shell.execCommand("whoami").split("\n")[0];

    assertEquals(usernameViaWhoami, UnixUserGroupInformation.getUnixUserName());
  }
}
