...
public class ServerHandler {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static class unsubscribe<I extends Iface> extends org.apache.thrift.ProcessFunction<I, unsubscribe_args> {
      public unsubscribe() {
        super("unsubscribe");
      }
      ...
      protected unsubscribe_result getResult(I iface, unsubscribe_args args) throws org.apache.thrift.TException {
        unsubscribe_result result = new unsubscribe_result();
        try {
    ...
    private static class registerClient<I extends Iface> extends org.apache.thrift.ProcessFunction<I, registerClient_args> {
      public registerClient() {
        super("registerClient");
      }

      protected registerClient_args getEmptyArgsInstance() {
        return new registerClient_args();
      }

      protected registerClient_result getResult(I iface, registerClient_args args) throws org.apache.thrift.TException {
        registerClient_result result = new registerClient_result();
        try {
    ...
    private static class unregisterClient<I extends Iface> extends org.apache.thrift.ProcessFunction<I, unregisterClient_args> {
      public unregisterClient() {
        super("unregisterClient");
      }

      protected unregisterClient_args getEmptyArgsInstance() {
        return new unregisterClient_args();
      }

      protected unregisterClient_result getResult(I iface, unregisterClient_args args) throws org.apache.thrift.TException {
        unregisterClient_result result = new unregisterClient_result();
        try {
  ...
  public static class subscribe_args implements org.apache.thrift.TBase<subscribe_args, subscribe_args._Fields>, java.io.Serializable, Cloneable   {
        ...
        switch (field.id) {
          ...
          case 2: // SUBSCRIBED_EVENT
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.subscribedEvent = new NamespaceEvent();
              this.subscribedEvent.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.subscribedEvent != null) {
        ...
        this.subscribedEvent.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  public static class subscribe_result implements org.apache.thrift.TBase<subscribe_result, subscribe_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          case 1: // INVALID_CLIENT_ID
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.invalidClientId = new InvalidClientIdException();
              this.invalidClientId.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
          case 2: // TRANSACTION_ID_TOO_OLD
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.transactionIdTooOld = new TransactionIdTooOldException();
              this.transactionIdTooOld.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetInvalidClientId()) {
        oprot.writeFieldBegin(INVALID_CLIENT_ID_FIELD_DESC);
        this.invalidClientId.write(oprot);
        oprot.writeFieldEnd();
      } else if (this.isSetTransactionIdTooOld()) {
        oprot.writeFieldBegin(TRANSACTION_ID_TOO_OLD_FIELD_DESC);
        this.transactionIdTooOld.write(oprot);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
  ...
  public static class unsubscribe_result implements org.apache.thrift.TBase<unsubscribe_result, unsubscribe_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          ...
          case 2: // CLIENT_NOT_SUBSCRIBED
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.clientNotSubscribed = new ClientNotSubscribedException();
              this.clientNotSubscribed.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetInvalidClientId()) {
        ...
        this.invalidClientId.write(oprot);
        oprot.writeFieldEnd();
      } else if (this.isSetClientNotSubscribed()) {
        oprot.writeFieldBegin(CLIENT_NOT_SUBSCRIBED_FIELD_DESC);
        this.clientNotSubscribed.write(oprot);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
  ...
  public static class registerClient_result implements org.apache.thrift.TBase<registerClient_result, registerClient_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          ...
          case 2: // CLIENT_CONNECTION
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.clientConnection = new ClientConnectionException();
              this.clientConnection.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetRampUp()) {
        ...
        this.rampUp.write(oprot);
        oprot.writeFieldEnd();
      } else if (this.isSetClientConnection()) {
        oprot.writeFieldBegin(CLIENT_CONNECTION_FIELD_DESC);
        this.clientConnection.write(oprot);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
