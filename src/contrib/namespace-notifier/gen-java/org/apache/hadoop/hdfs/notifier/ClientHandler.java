...
public class ClientHandler {
  ...
  public interface Iface {
    ...
    public void handleNotification(NamespaceNotification notification, long serverId) throws InvalidServerIdException, org.apache.thrift.TException;

    public void heartbeat(long serverId) throws InvalidServerIdException, org.apache.thrift.TException;

    public void registerServer(long clientId, long serverId, long token) throws InvalidTokenException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void handleNotification(NamespaceNotification notification, long serverId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.handleNotification_call> resultHandler) throws org.apache.thrift.TException;

    public void heartbeat(long serverId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.heartbeat_call> resultHandler) throws org.apache.thrift.TException;

    public void registerServer(long clientId, long serverId, long token, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.registerServer_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_handleNotification(NamespaceNotification notification, long serverId) throws org.apache.thrift.TException
    {
    ...
    public void send_heartbeat(long serverId) throws org.apache.thrift.TException
    {
    ...
    public void send_registerServer(long clientId, long serverId, long token) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void handleNotification(NamespaceNotification notification, long serverId, org.apache.thrift.async.AsyncMethodCallback<handleNotification_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class handleNotification_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public handleNotification_call(NamespaceNotification notification, long serverId, org.apache.thrift.async.AsyncMethodCallback<handleNotification_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void heartbeat(long serverId, org.apache.thrift.async.AsyncMethodCallback<heartbeat_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class heartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long serverId;
      public heartbeat_call(long serverId, org.apache.thrift.async.AsyncMethodCallback<heartbeat_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.serverId = serverId;
      }
    ...
    public void registerServer(long clientId, long serverId, long token, org.apache.thrift.async.AsyncMethodCallback<registerServer_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class registerServer_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long serverId;
      private long token;
      public registerServer_call(long clientId, long serverId, long token, org.apache.thrift.async.AsyncMethodCallback<registerServer_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static class handleNotification<I extends Iface> extends org.apache.thrift.ProcessFunction<I, handleNotification_args> {
      public handleNotification() {
        super("handleNotification");
      }

      protected handleNotification_args getEmptyArgsInstance() {
        return new handleNotification_args();
      }

      protected handleNotification_result getResult(I iface, handleNotification_args args) throws org.apache.thrift.TException {
        handleNotification_result result = new handleNotification_result();
        try {
  ...
  public static class handleNotification_args implements org.apache.thrift.TBase<handleNotification_args, handleNotification_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public handleNotification_args setServerId(long serverId) {
      this.serverId = serverId;
      setServerIdIsSet(true);
      return this;
    }
        ...
        switch (field.id) {
          case 1: // NOTIFICATION
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.notification = new NamespaceNotification();
  ...
  public static class handleNotification_result implements org.apache.thrift.TBase<handleNotification_result, handleNotification_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          case 1: // INVALID_SERVER_ID
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.invalidServerId = new InvalidServerIdException();
              this.invalidServerId.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetInvalidServerId()) {
        oprot.writeFieldBegin(INVALID_SERVER_ID_FIELD_DESC);
        this.invalidServerId.write(oprot);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
  ...
  public static class heartbeat_args implements org.apache.thrift.TBase<heartbeat_args, heartbeat_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public heartbeat_args setServerId(long serverId) {
      this.serverId = serverId;
      setServerIdIsSet(true);
      return this;
    }
  ...
  public static class registerServer_args implements org.apache.thrift.TBase<registerServer_args, registerServer_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final int __TOKEN_ISSET_ID = 2;
    ...
    public void unsetToken() {
      __isset_bit_vector.clear(__TOKEN_ISSET_ID);
    }

    /** Returns true if field token is set (has been assigned a value) and false otherwise */
    public boolean isSetToken() {
      return __isset_bit_vector.get(__TOKEN_ISSET_ID);
    }

    public void setTokenIsSet(boolean value) {
      __isset_bit_vector.set(__TOKEN_ISSET_ID, value);
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(this.clientId);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(SERVER_ID_FIELD_DESC);
      oprot.writeI64(this.serverId);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(TOKEN_FIELD_DESC);
      oprot.writeI64(this.token);
      oprot.writeFieldEnd();
      oprot.writeFieldStop();
      oprot.writeStructEnd();
    }
  ...
  public static class registerServer_result implements org.apache.thrift.TBase<registerServer_result, registerServer_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          case 1: // INVALID_TOKEN
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.invalidToken = new InvalidTokenException();
              this.invalidToken.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.isSetInvalidToken()) {
        oprot.writeFieldBegin(INVALID_TOKEN_FIELD_DESC);
        this.invalidToken.write(oprot);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
