...
public class TestRaidShellFsck_CorruptCounter {
  ...
  private void setUp(boolean doHar) throws IOException, ClassNotFoundException {
    ...
    args[0] = "-fsck";
    args[1] = DIR_PATH;
    args[2] = "-retNumStrpsMissingBlksRS";
...
/**
  ...
  public void testCountersInCorruptFileCounter() 
    ...
    System.err.println("Checking Raid Node") ;
   ...
   System.err.println("Checking Raid Node Metrics") ;
