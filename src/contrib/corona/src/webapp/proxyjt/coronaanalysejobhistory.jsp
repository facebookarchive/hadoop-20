...
%>
<h2>Hadoop Job <a href="coronajobdetailshistory.jsp?jobid=<%=jobid%>&&logFile=<%=encodedLogFileName%>"><%=jobid %> </a></h2>
...
<a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=<%=encodedLogFileName%>&taskid=<%=minMap.get(Keys.TASKID)%>">
...
%>
    <tr>
    <td><a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=<%=encodedLogFileName%>&taskid=<%=mapTasks[i].get(Keys.TASKID)%>">
...
<a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=<%=encodedLogFileName%>
...
%>
    <tr>
    <td><a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=
...
<a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=<%=encodedLogFileName%>&taskid=<%=minReduce.get(Keys.TASKID)%>">
...
%>
    <tr>
    <td><a href="coronataskdetailshistory.jsp?jobid=<%=jobid%>&logFile=<%=encodedLogFileName%>&taskid=<%=reduceTasks[i].get(Keys.TASKID)%>">
        <%=reduceTasks[i].get(Keys.TASKID) %></a></td>
