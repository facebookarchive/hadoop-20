...
/**
 * Reports the resource utilization on the TaskTracker to {@link Collector}
 */
public class UtilizationReporter implements Configurable {
  ...
  protected CollectorProtocol rpcCollector;
  ...
  /**
   * Create the the {@link CollectorProtocol} RPC object
  ...
  /**
   * Transmit the {@link TaskTrackerUtilization} to {@link CollectorProtocol}
   * via RPC
   */
  ...
  /**
   * Keep submitting information to {@link Collector}
   */
  void start() {
    while (true) {
      try {
