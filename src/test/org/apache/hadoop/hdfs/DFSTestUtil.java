...
public class DFSTestUtil extends TestCase {
  ...
  public static void createFile(FileSystem fs, Path fileName, long fileLen,
      short replFactor, long seed, InetSocketAddress[] favoredNodes) throws IOException{
    ...
    try {
      if (favoredNodes == null){
        ...
        out = ((DistributedFileSystem) fs).create(fileName, FsPermission.getDefault(), true, fs
            .getConf().getInt("io.file.buffer.size", 4096), replFactor, fs.getDefaultBlockSize(),
  ...
  public static void createFile(FileSystem fs, Path fileName, long fileLen,
    ...
    createFile(fs, fileName, fileLen, replFactor, seed, null);
  }
