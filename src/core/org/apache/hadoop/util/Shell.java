...
abstract public class Shell {
  ...
  public static final String NO_SHELL_CALL_ALLOWED_STRING =
    "NO_SHELL_CALL_ALLOWED";
  
  /**
   * Set if the shell calls are disabled.
   * @param disabled
   */
  ...
  /**
   * Are shell calls disabled?
   * @return true if shell calls are disabled.
   */
  ...
  private synchronized void runCommand() throws IOException {
    ...
    if (isDisabled()) {
      ...
      // Make the execution result a fixed string.
