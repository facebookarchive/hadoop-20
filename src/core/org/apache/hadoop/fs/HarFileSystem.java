...
public class HarFileSystem extends FilterFileSystem {
  ...
  public BlockLocation[] getFileBlockLocations(FileStatus file, long start,
    ...
    return new BlockLocation[]{new BlockLocation(null, null, 0, file.getLen())};
  }
        ...
        if ((child.startsWith(parentString))) {
          ...
          if (thisPath.depth() == harlen + 1) {
            ...
            FileStatus childStatus = new FileStatus(hstatus.isDir() ? 0
                ...
                hstatus.getGroup(), makeRelative(this.uri.toString(),
  ...
  public FileStatus getFileStatus(Path f) throws IOException {
    ...
    hstatus = new HarStatus(readStr,archiveStatus);
