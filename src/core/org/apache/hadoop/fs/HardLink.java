...
public class HardLink { 
  ...
  private static class HardLinkCGUnix extends HardLinkCommandGetter {
    private static ThreadLocal<String[]> hardLinkCommand = 
      new ThreadLocal<String[]>() {
        @Override
        protected String[] initialValue() {
          return new String[]{"ln", null, null};
        }
      };
    private static String[] hardLinkMultPrefix = {"ln"};
    private static String[] hardLinkMultSuffix = {null};
    private static ThreadLocal<String[]> getLinkCountCommand = 
      new ThreadLocal<String[]>() {
        @Override
        protected String[] initialValue() {
          if (osType == OSType.OS_TYPE_MAC) {
            return new String[] {"stat","-f%l", null};
          } else if (osType == OSType.OS_TYPE_SOLARIS) {
            return new String[] {"ls","-l", null};
          } else {
