...
public class JobConf extends Configuration {
  ...
  /**
   * Get progress gap to invoke speculative execution for maps.
   * 
   * @param mapSpeculativeGap get value for speculative gap.
   */
  public float getMapSpeculativeGap() { 
    return getFloat("mapred.speculative.map.gap", 0.2f);
  }

  /**
   * Set progress gap to invoke speculative execution for maps.
   * 
   * @param mapSpeculativeGap New value for speculative gap.
   */
  public void setMapSpeculativeGap(float mapSpeculativeGap) { 
    set("mapred.speculative.map.gap", "" + mapSpeculativeGap);
  }
  ...
  /**
   * Get progress gap to invoke speculative execution for reduces.
   */
  public float getReduceSpeculativeGap() { 
    return getFloat("mapred.speculative.reduce.gap", 0.2f);
  }
  
  /**
   * Set progress gap to invoke speculative execution for reduces.
   * 
   * @param reduceSpeculativeGap New value for speculative gap.
   */
  public void setReduceSpeculativeGap(float reduceSpeculativeGap) { 
    set("mapred.speculative.reduce.gap", "" + reduceSpeculativeGap);
  }
