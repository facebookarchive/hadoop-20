...
public final class coronataskdetailshistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String type = task.get(Keys.TASK_TYPE);
      ...
      out.write("\n<html>\n<body>\n<h2>");
      out.print(taskid );
      out.write(" attempts for <a href=\"coronajobdetailshistory.jsp?jobid=");
      out.print(jobid);
      out.write("&&logFile=");
