...
public final class coronajobdetailshistory_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 static SimpleDateFormat dateFormat = new SimpleDateFormat("d-MMM-yyyy HH:mm:ss") ; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    JobInfo job = JSPUtil.getJobInfo(request, fs);
      ...
      out.print(jobid );
      out.write(" on <a href=\"coronajobhistory.jsp\">History Viewer</a></h2>\n\n<b>User: </b> ");
      out.print(job.get(Keys.USER) );
      out.write("<br/> \n<b>JobName: </b> ");
      out.print(job.get(Keys.JOBNAME) );
      out.write("<br/> \n<b>JobConf: </b> <a href=\"coronajobconf_history.jsp?jobid=");
      out.print(jobid);
      out.write("&jobLogDir=");
