...
public final class coronaanalysejobhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  JobInfo job = JSPUtil.getJobInfo(request, fs);
      ...
      out.write("\n<h2>Hadoop Job <a href=\"coronajobdetailshistory.jsp?jobid=");
      out.print(jobid);
      out.write("&&logFile=");
  ...
  JobHistory.Task minMap = mapTasks[mapTasks.length-1] ;
      ...
      out.write("\n\n<h3>Time taken by best performing Map task \n<a href=\"coronataskdetailshistory.jsp?jobid=");
      out.print(jobid);
      out.write("&logFile=");
      out.print(encodedLogFileName);
      out.write("&taskid=");
  ...
  for (int i=0;i<showTasks && i<mapTasks.length; i++) {
      ...
      out.write("\n    <tr>\n    <td><a href=\"coronataskdetailshistory.jsp?jobid=");
      out.print(jobid);
      out.write("&logFile=");
      out.print(encodedLogFileName);
      out.write("&taskid=");
